...
Known ICAO Cache:
┌─────────────────────────────────────────────────────────────┐
│ From DF11/DF17:    ICAO directly in message → Add to cache │
...
- [ ] Direct RTL-SDR library integration (librtlsdr)
- [ ] TIS-B and ADS-R message support
- [ ] Mode A/C decoding
- [ ] MLAT (Multilateration) support
- [ ] Database integration for aircraft information
- [ ] Improved signal processing algorithms
- [ ] Additional output formats (KML, GeoJSON)
...
1. **ICAO Annex 10, Volume IV** - Surveillance and Collision Avoidance Systems
2. **RTCA DO-260B** - MOPS for 1090 MHz Extended Squitter ADS-B and TIS-B
3. **ICAO Doc 9871** - Technical Provisions for Mode S Services and Extended Squitter

### Resources

- [The 1090 Megahertz Riddle](https://mode-s.org/decode/) - Comprehensive ADS-B decoding guide
- [ADS-B Exchange](https://www.adsbexchange.com/) - Global ADS-B data sharing network
- [FlightAware](https://flightaware.com/adsb/) - ADS-B receiver information
- [Original dump1090](https://github.com/antirez/dump1090) - Salvatore Sanfilippo's original implementation

### Related Projects

- [dump1090-fa](https://github.com/flightaware/dump1090) - FlightAware's enhanced version
- [readsb](https://github.com/wiedehopf/readsb) - Modern dump1090 fork
- [pyModeS](https://github.com/junzis/pyModeS) - Python Mode S decoder library
...
- **Salvatore Sanfilippo (antirez)** - Original dump1090 implementation
- **Junzi Sun** - The 1090MHz Riddle documentation
- **ICAO** - Mode S and ADS-B specifications
- The RTL-SDR and ADS-B communities

---

<p align="center">
  <a href="https://github.com/ktauchathuranga/adsb">GitHub</a> •
  <a href="https://github.com/ktauchathuranga/adsb/issues">Issues</a> •
  <a href="https://github.com/ktauchathuranga/adsb/pulls">Pull Requests</a>
</p>